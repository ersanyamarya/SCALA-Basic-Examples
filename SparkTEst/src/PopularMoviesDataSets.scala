...
object PopularMoviesDataSets {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    var movieNames:Map[Int, String] = Map()
     ...
     val lines = Source.fromFile("/home/arya/workspaces/workspace_scala/u.item").getLines()
     for (line <- lines) {
  ...
  def main(args: Array[String]) {
    ...
    val lines = spark.sparkContext.textFile("/home/arya/workspaces/workspace_scala/u.data").map(x => Movie(x.split("\t")(1).toInt))
